        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
          ...
          <div className="lg:sticky lg:top-24 self-start">
            <div className="relative mb-4 overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm">
              ...
              <div className="absolute top-4 left-4 flex flex-wrap gap-2">
                {product.category && (
                  <span className="inline-flex items-center rounded-full bg-black/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-white shadow-sm">
                    {product.category}
                  </span>
                )}
                {effectiveDisplayQuantity && (
                  <span className="inline-flex items-center rounded-full bg-white/90 px-2.5 py-1 text-[11px] font-medium text-slate-800 ring-1 ring-gray-200">
                    Pack: {effectiveDisplayQuantity}
                  </span>
                )}
                {product.isOrganic && (
                  <span className="inline-flex items-center rounded-full bg-amber-50/95 px-2.5 py-1 text-[11px] font-medium text-amber-800 ring-1 ring-amber-200">
                    <Leaf size={14} className="mr-1" />
                    Organic
                  </span>
                )}
